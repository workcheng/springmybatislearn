...
define([
	'recruitersModule',
		...
		recruiters.directives.register('commentsDirectives',['$filter','commentsService','$stateParams','userService',
			...
			return {
				...
				template:function(tElement,tAttrs){
					...
					<div class="tab-header">\
						<div class="tab-title">'+title+'的评论<small class="text_color_grey">(仅企业内部成员可见，用于JOHO沟通)</small></div>\
					</div>\
